...
public class SystemInfoBinding {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
            MemoryLayout.unionLayout(
                    Kernel32Common.C_LONG.withName("dwOemId"),
                    MemoryLayout.structLayout(
                            Kernel32Common.C_SHORT.withName("wProcessorArchitecture"),
                            Kernel32Common.C_SHORT.withName("wReserved")
                    ).withName("$anon$50:9")
            ).withName("$anon$48:5"),
            Kernel32Common.C_LONG.withName("dwPageSize"),
            Kernel32Common.C_POINTER.withName("lpMinimumApplicationAddress"),
            Kernel32Common.C_POINTER.withName("lpMaximumApplicationAddress"),
            Kernel32Common.C_LONG_LONG.withName("dwActiveProcessorMask"),
            Kernel32Common.C_LONG.withName("dwNumberOfProcessors"),
            Kernel32Common.C_LONG.withName("dwProcessorType"),
            Kernel32Common.C_LONG.withName("dwAllocationGranularity"),
            Kernel32Common.C_SHORT.withName("wProcessorLevel"),
            Kernel32Common.C_SHORT.withName("wProcessorRevision")
